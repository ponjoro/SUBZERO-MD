...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~RgRW3TzS#PtYwiFv6xnHgsWPcaAGM_NlqHqvJelcdHonrFp9mS8E",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "255784534614",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "Mr Frank",           // Owner's name
    DEV: process.env.DEV || "255784534614",                     // Developer's contact number
    DEVELOPER_NUMBER: '255784534614@s.whatsapp.net',            // Developer's WhatsApp ID
